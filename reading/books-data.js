...
const BOOKS = [
  ...
  { title: "Fifty Shades Trilogy Boxed Set (Fifty Shades, #1-3)",           author: "E.L. James",                   rating: 2, dateRead: "", genre: "Romance",          language: "English"  },
  { title: "Jaag Uthi Nari Shakti",                                         author: "Kiran Bedi",                   rating: 5, dateRead: "", genre: "Non-fiction",      language: "Hindi"    },
  { title: "Great Russian Short Stories",                                   author: "Paul Negri",                   rating: 4, dateRead: "", genre: "Classic",          language: "English"  },
  ...
  { title: "The Prophet",                                                   author: "Kahlil Gibran",                rating: 5, dateRead: "", genre: "Poetry",           language: "English"  },
  { title: "Animal Farm",                                                   author: "George Orwell",                rating: 5, dateRead: "", genre: "Classic",          language: "English"  },
  { title: "1984",                                                          author: "George Orwell",                rating: 5, dateRead: "", genre: "Dystopian",        language: "English"  },
  { title: "Harry Potter and the Sorcerer's Stone (Harry Potter, #1)",      author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: "Fantasy",          language: "English"  },
  { title: "Harry Potter and the Chamber of Secrets (Harry Potter, #2)",    author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: "Fantasy",          language: "English"  },
  { title: "Harry Potter and the Prisoner of Azkaban (Harry Potter, #3)",   author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: "Fantasy",          language: "English"  },
  { title: "Harry Potter and the Goblet of Fire (Harry Potter, #4)",        author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: "Fantasy",          language: "English"  },
  { title: "Harry Potter and the Order of the Phoenix (Harry Potter, #5)",  author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: "Fantasy",          language: "English"  },
  { title: "Harry Potter and the Half-Blood Prince (Harry Potter, #6)",     author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: "Fantasy",          language: "English"  },
  { title: "Harry Potter and the Deathly Hallows (Harry Potter, #7)",       author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: "Fantasy",          language: "English"  },
  { title: "Twilight (Twilight Saga, #1)",                                  author: "Stephenie Meyer",              rating: 5, dateRead: "", genre: "Fantasy",          language: "English"  },
  { title: "Wings of Fire: An Autobiography",                               author: "A.P.J. Abdul Kalam",           rating: 5, dateRead: "", genre: "Biography",        language: "English"  },
  { title: "The Alchemist",                                                 author: "Paulo Coelho",                 rating: 3, dateRead: "", genre: "Literary Fiction", language: "English"  },
  { title: "The Fault in Our Stars",                                        author: "John Green",                   rating: 3, dateRead: "", genre: "Young Adult",      language: "English"  },
  { title: "The Immortals of Meluha (Shiva Trilogy, #1)",                   author: "Amish Tripathi",               rating: 3, dateRead: "", genre: "Mythology",        language: "English"  },
  { title: "The Secret of the Nagas (Shiva Trilogy, #2)",                   author: "Amish Tripathi",               rating: 3, dateRead: "", genre: "Mythology",        language: "English"  },
  { title: "The Oath of the Vayuputras (Shiva Trilogy, #3)",                author: "Amish Tripathi",               rating: 3, dateRead: "", genre: "Mythology",        language: "English"  },
