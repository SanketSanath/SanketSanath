...
const BOOKS = [
  ...
  { title: "Musafir Cafe",                                                  author: "Divya Prakash Dubey",          rating: 4, dateRead: "2026/03/02", genre: ["Hindi Fiction"],                     language: "Hindi"    },
  ...
  { title: "Harry Potter and the Sorcerer's Stone (Harry Potter, #1)",      author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: ["Fantasy", "Young Adult"],           language: "English"  },
  { title: "Harry Potter and the Chamber of Secrets (Harry Potter, #2)",    author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: ["Fantasy", "Young Adult"],           language: "English"  },
  { title: "Harry Potter and the Prisoner of Azkaban (Harry Potter, #3)",   author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: ["Fantasy", "Young Adult"],           language: "English"  },
  { title: "Harry Potter and the Goblet of Fire (Harry Potter, #4)",        author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: ["Fantasy", "Young Adult"],           language: "English"  },
  { title: "Harry Potter and the Order of the Phoenix (Harry Potter, #5)",  author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: ["Fantasy", "Young Adult"],           language: "English"  },
  { title: "Harry Potter and the Half-Blood Prince (Harry Potter, #6)",     author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: ["Fantasy", "Young Adult"],           language: "English"  },
  { title: "Harry Potter and the Deathly Hallows (Harry Potter, #7)",       author: "J.K. Rowling",                 rating: 5, dateRead: "", genre: ["Fantasy", "Young Adult"],           language: "English"  },
